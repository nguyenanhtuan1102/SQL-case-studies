...
INSERT INTO DB.customer (customer_id)
SELECT Number
FROM Numbers
WHERE Number <= 500;
...
CREATE TABLE DB.customer_nodes (
    customer_id INT,
    region_id INT,
	node_id INT,
    start_date DATE,
    ...
    FOREIGN KEY (region_id) REFERENCES DB.regions(region_id)
);

INSERT INTO DB.customer_nodes (
	customer_id, 
	region_id, 
	node_id, 
	start_date, 
...
CREATE TABLE DB.customer_transactions (
  customer_id INTEGER,
  txn_date DATE,
  txn_type VARCHAR(10),
  txn_amount INTEGER,
...
INSERT INTO DB.customer_transactions (
	customer_id, 
	txn_date, 
	txn_type, 
	txn_amount
